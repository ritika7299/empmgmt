    ...
    <div class="page-header-content header-elements-md-inline">
      <div class="page-title d-flex">
        <h4>
          ...
          <span class="font-weight-semibold">Dashboard</span> - In-Completed List
        </h4>
    ...
    <div class="breadcrumb-line breadcrumb-line-light header-elements-md-inline">
      <div class="d-flex">
        <div class="breadcrumb">
          ...
          <span class="breadcrumb-item active">In-Completed Employee List</span>
        </div>
                        ...
                        <tbody>
                          <tr role="row" class="odd">
                            ...
                            <td class="text-center">
                              <a href="javascript::void(0);" class="btn bg-purple-800 btn-sm">click</a>
                            </td>
                          </tr>
                          <tr role="row" class="even">
                            ...
                            <td>Deptt One</td>
                            <td class="text-center">
                              <a href="<?//= base_url('form/continue/' . $form['personal_info_id']) ?>"
                                class="btn bg-purple-800 btn-sm">click</a>
                            </td>
                          </tr>
                        </tbody>
                      </table>
